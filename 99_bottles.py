...
You need to pass n to StandardVerse, n can only be equal to one number at a time so use if/elis's and else, don't print your function calls as the return no value so None by default which you will see if you print:
